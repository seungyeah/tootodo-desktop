...
<script lang="ts">
    ...
    let { tab1, tab2, class: className }: Props = $props();
...
>
   ...
   data-[orientation=vertical]:flex-col data-[orientation=vertical]:border-r"
    ...
    <div use:melt={$content("tab-1")} class="content no-scrollbar">
        {@render tab1?.()}
    </div>
...
<style lang="postcss">
    .content {
        @apply h-full max-h-full m-2 overflow-y-auto  border-2 border-double  border-neutral-600;
    }
