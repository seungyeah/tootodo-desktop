<script lang="ts">
    ...
    import {BotMessageSquare, ListChecks, Search, Trash2} from "lucide-svelte";
...
<div class="relative flex flex-col w-full h-full">
    ...
    >
        ...
        >
            ...
            <!-- duration picker -->
            <div
                    class="-translate-x-2 w-full text-xs text-center font-digital text-zinc-600 text-nowrap bg-zinc-100"
            >
            ...
            <Resizable.Handle withHandle class="-translate-x-2 bg-zinc-400" handleClass="absolute left-4"/>
